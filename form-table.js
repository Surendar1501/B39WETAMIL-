...
h1Ele.innerText = "forms";
h1Ele.style.marginLeft = "500px";
...
pELe.id = "description";
pELe.innerText = "using DOM to create a form";
pELe.style.marginLeft = "450px";
const formElement = document.createElement("form");
formElement.id = "form";
formElement.append(h1Ele, pELe);
const fields = [
